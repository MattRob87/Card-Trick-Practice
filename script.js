...
function generate() {
  ...
  // Reset the result card: reset label, image and remove flip animation.
  document.getElementById("resultLabel").textContent = "?";
  document.getElementById("resultFrontImage").src = "images/back.png";
...
function revealRightCard() {
  // Update the image on the back side of the flip card
  document.getElementById("resultFrontImage").src =
    "images/" + imageDeck[resultPos - 1] + ".png";
  // Add the flipped class to animate the flip
